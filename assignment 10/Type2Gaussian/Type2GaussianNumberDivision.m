...
fill(X,Y,'r');  
       subplot(312)
h3=gaussmf(l,[1 7]);
plot(l,h3,'m','linewidth',1.5)
hold on
h4=gaussmf(l,[0.5 7]);
plot(l,h4,'m','linewidth',1.5)
...
fill(X,Y,'m');
      ...
      subplot(313)
plot(s1L,y,'k','linewidth',2)
hold on
plot(s2L,y,'k','linewidth',2)
hold on
plot(s1U,y,'k','linewidth',2)
hold on
plot(s2U,y,'k','linewidth',2)
axis([0,10,0,1.1])
hold on
...
title('Division -------Type II Gaussian fuzzy Number')
